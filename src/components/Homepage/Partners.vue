<template>
    <div class="px-5 mb-5 lg:px-20">
        <h5 class="block text-blue-800 text-lg text-center font-semibold mb-3 lg:text-2xl">
            OUR PARTNERS
        </h5>

        <div class="flex flex-wrap gap-2 justify-center">
            <div class="h-20 w-20 flex justify-center items-center">
                <img src="@/assets/partners/apple.png" alt="apple" class="h-12">
            </div>

            <div class="h-20 w-20 flex justify-center items-center">
                <img src="@/assets/partners/hp.png" alt="hp" class="h-16">
            </div>
            
            <div class="h-20 w-20 flex justify-center items-center">
                <img src="@/assets/partners/dell.png" alt="dell">
            </div>

            <div class="h-20 w-20 flex justify-center items-center">
                <img src="@/assets/partners/huawei.png" alt="huawei">
            </div>

            <div class="h-20 w-20 flex justify-center items-center">
                <img src="@/assets/partners/vmware.svg" alt="vmware">
            </div>

            <div class="h-20 w-20 flex justify-center items-center">
                <img src="@/assets/partners/h3c.png" alt="h3c">
            </div>

            <div class="h-20 w-20 flex justify-center items-center">
                <img src="@/assets/partners/oki.png" alt="oki">
            </div>
            ...
            <div class="h-20 w-20 flex justify-center items-center">
                <img src="@/assets/partners/comscope.png" alt="comscope">
            </div>

            <div class="h-20 w-20 flex justify-center items-center">
                <img src="@/assets/partners/hpe_aruba.png" alt="hpe_aruba">
            </div>



            <div class="h-20 w-20 flex justify-center items-center">
                <img src="@/assets/partners/panduit.png" alt="panduit">
            </div>

            <div class="h-20 w-20 flex justify-center items-center">
                <img src="@/assets/partners/ruijie.png" alt="ruijie">
            </div>
            ...
            <div class="h-20 w-[90px] flex justify-center items-center">
                <img src="@/assets/partners/sangfor.png" alt="sangfor">
            </div>
        </div>
    </div>
</template>